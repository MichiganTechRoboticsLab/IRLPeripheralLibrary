...
namespace IRL
{
    ...
    public:
        ...
        virtual bool getMeasurement(std::vector<long>& data,long* timestamp = NULL);
        virtual bool getIntensity(std::vector<long>& data, std::vector< unsigned short> & intensity, long* timestamp = NULL);
